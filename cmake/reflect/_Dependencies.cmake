...
#
if( COLLECT_DEPENDENCY_LIBRARIES_AS_NAMES)
   list( APPEND DEPENDENCY_LIBRARIES "mulle-linkedlist")
else()
   if( NOT MULLE__LINKEDLIST_LIBRARY)
      foreach( _TMP_MULLE__LINKEDLIST_LIBRARY_TARGET mulle-linkedlist)
         if( TARGET ${_TMP_MULLE__LINKEDLIST_LIBRARY_TARGET})
            set( MULLE__LINKEDLIST_LIBRARY ${_TMP_MULLE__LINKEDLIST_LIBRARY_TARGET})
            break()
         endif()
      endforeach()
      if( NOT MULLE__LINKEDLIST_LIBRARY)
         find_library( MULLE__LINKEDLIST_LIBRARY NAMES
            ${MULLE_PREFERRED_LIBRARY_PREFIX}mulle-linkedlist${CMAKE_DEBUG_POSTFIX}${MULLE_PREFERRED_LIBRARY_SUFFIX}
            ${MULLE_PREFERRED_LIBRARY_PREFIX}mulle-linkedlist${MULLE_PREFERRED_LIBRARY_SUFFIX}
            ${MULLE_FALLBACK_LIBRARY_PREFIX}mulle-linkedlist${CMAKE_DEBUG_POSTFIX}${MULLE_FALLBACK_LIBRARY_SUFFIX}
            ${MULLE_FALLBACK_LIBRARY_PREFIX}mulle-linkedlist${MULLE_FALLBACK_LIBRARY_SUFFIX}
            mulle-linkedlist
            NO_CMAKE_SYSTEM_PATH NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_FIND_ROOT_PATH
         )
   ...
   if( MULLE__LINKEDLIST_LIBRARY)
         ...
         #
         if( NOT ${MULLE__LINKEDLIST_LIBRARY} IN_LIST DEPENDENCY_LIBRARIES)
         ...
         foreach( _TMP_MULLE__LINKEDLIST_NAME "mulle-linkedlist")
            ...
            if( IS_DIRECTORY "${_TMP_MULLE__LINKEDLIST_DIR}")
               ...
               unset( MULLE__LINKEDLIST_RENDEZVOUS_GLOBALS)
               ...
               include( "${_TMP_MULLE__LINKEDLIST_DIR}/Definitions.cmake" OPTIONAL)
               list( APPEND RENDEZVOUS_GLOBALS ${MULLE__LINKEDLIST_RENDEZVOUS_GLOBALS})
               break()
            else()
      ...
      message( SEND_ERROR "MULLE__LINKEDLIST_LIBRARY was not found in ${MULLE_PREFERRED_LIBRARY_PREFIX}mulle-linkedlist${CMAKE_DEBUG_POSTFIX}${MULLE_PREFERRED_LIBRARY_SUFFIX}
${MULLE_PREFERRED_LIBRARY_PREFIX}mulle-linkedlist${MULLE_PREFERRED_LIBRARY_SUFFIX}
${MULLE_FALLBACK_LIBRARY_PREFIX}mulle-linkedlist${CMAKE_DEBUG_POSTFIX}${MULLE_FALLBACK_LIBRARY_SUFFIX}
${MULLE_FALLBACK_LIBRARY_PREFIX}mulle-linkedlist${MULLE_FALLBACK_LIBRARY_SUFFIX}
mulle-linkedlist")
