if( NOT __MULLE_ABA_DEPENDENCIES_AND_LIBRARIES_CMAKE__)
   set( __MULLE_ABA_DEPENDENCIES_AND_LIBRARIES_CMAKE__ ON)
   ...
   #
   #if( MSVC)
   #   set( MULLE_ABA_DEFINITIONS $<|PARENT_IDENTIFIER|>_DEFINITIONS})
   #endif()
endif()
